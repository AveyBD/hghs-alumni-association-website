            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-haspopup="false"
                  tabIndex="0"
                  className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-red-900 focus:bg-red-50 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
              ...
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-haspopup="false"
                  tabIndex="0"
                  className="flex items-center gap-2 py-4 text-red-900 transition-colors duration-300 hover:text-red-900 focus:bg-red-50 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
                  <span>News</span>
                </a>
